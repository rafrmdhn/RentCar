            ...
            <div class="row">
                <div class="col-12 col-md-8">                    
                        ...
                        <select class="form-control" name="id_type" required="">
                            ...
                            <?php
                                ...
                                while ($data = mysqli_fetch_assoc($query_type)) {?>
                                    <option value="<?=$data['id_type']?>"><?=$data['jenis']?></option>
                                <?php }?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tahun" class="form-control" placeholder="Tahun Kendaraan" required="">
                    </div>
                    <div class="form-group">
...
<?php
    ...
    if(isset($_POST['tambah'])){
        ...
        $query_tambah = "INSERT INTO tbl_mobil (id_type, nama_kendaraan, no_plat, warna, harga, gambar, tahun, status_sewa)
                        VALUES ('$id_type', '$nama_kendaraan', '$no_plat', '$warna', '$harga', '$gambar', '$tahun', '$status_sewa')";
