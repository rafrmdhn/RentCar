    ...
    <main id="main" class="main">
        ...
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Home / Pages / Pelanggan</li>
            </ol>
                                ...
                                <tbody>
                                    <?php while ($result = mysqli_fetch_assoc($sql)) { ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?=$result['nama_pelanggan']?></td>
                                            <td class="text-center"><?=$result['email_pelanggan']?></td>
                                            <td class="text-center"><?=$result['password']?></td>
                                            <td class="text-center">
                                                <button type="button" name="hapus" class="btn btn-danger btn-sm text-white" data-bs-toggle="modal" data-bs-target="#hapus<?=$no?>"><i class="fas fa-trash"></i>Hapus</button>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <h4>Apakah Anda Yakin ? Ingin menghapus akun pelanggan <span class="badge bg-danger"><?=$result['nama_pelanggan']?></span></h4>
...
<?php
    ...
    if (isset($_POST['hapus'])) {
        ...
        $sql = mysqli_query($conn, "DELETE FROM tbl_pelanggan WHERE id_pelanggan = '$id'");
        if ($sql) {
